...
//=============================================================================
 /*:
 * @plugindesc (Requires YEP_StatusMenuCore.js) Logs the battle statistics
 * of actors for your players to view.
 ...
 * Make sure this plugin is located under YEP_StatusMenuCore in the plugin list.
 *
 ...
 *
 * Battles Initiated    - How many battles the actor was present in the starting
 *                        party and what ratio.
 * Kills/Deaths/Assists - Displays information about how many kills, deaths,
 *                        and assists performed by the actor overall. Kills
 *                        rise when the actor defeats an enemy. Deaths rise if
 *                        the actor falls in battle. Assists rise if the actor
 *                        is present during an enemy kill.
 * Damage Dealt         - Total amount of damage dealt by the actor over the
 *                        course of the game.
 * Damage Taken         - Total amount of damage taken by the actor over the
 *                        course of the game.
 * Healing Dealt        - Total amount of healing dealt by the actor over the
 *                        course of the game.
 * Healing Taken        - Total amount of healing taken by the actor over the
 *                        course of the game.
 */
//=============================================================================
...
Yanfly.BStats.Game_Actor_onBattleStart = Game_Actor.prototype.onBattleStart;
Game_Actor.prototype.onBattleStart = function() {
    Yanfly.BStats.Game_Actor_onBattleStart.call(this);

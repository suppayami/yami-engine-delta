//=============================================================================
// Yanfly Engine Plugins - Core Artificial Intelligence
// YEP_CoreAI.js
// Version: 1.00
//=============================================================================

var Imported = Imported || {};
Imported.YEP_CoreAI = true;
 ...
 * @desc If enabled, enemy actions are decided on the spot instead of
 * at the start of turn.   NO - false     YES - true
 * @default true
 *
 ...
 * Level 0: Very Dumb     Level 100: Very Intelligent
 * @default 80
 *
 * @help
 * ============================================================================
 ...
 * stat PARAM eval
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 * Replace 'stat' with either 'atk', 'def', 'mat', 'mdf', 'agi', 'luk', 'maxhp',
 * 'maxmp', 'hp', 'mp', 'hp%', 'mp%', or 'level' to run it in a condition check
 * again to see if the action gets passed. The group that it checks will be
 * based on the skill's scope. If the skill targets foes, then all foes will
 * take a check to see if they fulfill the conditions. Likewise for party
 * members if the skill is for allies. The valid targets will be those who pass
 * the condition check.
 *- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
Yanfly.Parameters = PluginManager.parameters('YEP_CoreAI');
